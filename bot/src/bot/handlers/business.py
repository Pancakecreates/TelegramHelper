...
AUTO_REPLY_SYSTEM_BASE = (
    ...
    "Обязательно обрати внимание на важные вопросы собеседника из истории недавних сообщений (например, «ты занят?», «где ты?»), которые остались без моего ответа, и ответь на них.\n"
